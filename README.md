...
- Após realizar as **previsões com o Prophet**, tanto para novos **casos** quanto para novos **óbitos**, consegui obter **modelos com curvas bem ajustadas e com dados de teste aderidos à curva**. Ambos **os modelos**,  **mostram uma tendência de queda para os próximos meses.** Portanto, as duas hipóteses levantandas no ínicio do projeto foram respondidas: Sim, após alguns meses de vacinação houve queda de casos e óbitos e a tendência é de que continuem diminuindo! 
